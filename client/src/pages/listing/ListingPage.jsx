    ...
    <div className="min-h-screen w-full bg-background p-4 md:p-8 animate-in fade-in duration-500">
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <div className="flex flex-col space-y-2">
          <Badge variant="outline" className="w-fit text-primary border-primary/20 px-3 py-1 text-xs uppercase tracking-widest bg-primary/5">
            Seller Dashboard
          </Badge>
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Track your inventory, manage stock levels, and list new crops for sale—all in one place.
          </p>
        </div>
        ...
        <Tabs defaultValue="overview" className="w-full space-y-6">
          <div className="flex items-center justify-between">
            <TabsList className="grid w-full md:w-auto grid-cols-3 h-12 bg-muted/40 p-1 rounded-xl gap-2">
              <TabsTrigger
                value="overview"
                className="data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:shadow-sm rounded-lg flex gap-2 items-center px-4"
              >
              ...
              <TabsTrigger
                value="harvested"
                className="data-[state=active]:bg-background data-[state=active]:text-destructive/90 data-[state=active]:shadow-sm rounded-lg flex gap-2 items-center px-4"
              >
              ...
              <TabsTrigger
                value="pre-harvest"
                className="data-[state=active]:bg-background data-[state=active]:text-primary/90 data-[state=active]:shadow-sm rounded-lg flex gap-2 items-center px-4"
              >
