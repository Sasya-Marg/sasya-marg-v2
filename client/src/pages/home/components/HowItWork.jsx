...
const steps = [
  {
    ...
    description: "Input your region, soil type (e.g., Black, Alluvial), and water availability to help us understand your land.",
    icon: <ClipboardList className="h-8 w-8 text-primary" />,
  },
  {
    number: "02",
    title: "AI Analysis",
    description: "Our rule-based AI cross-references your data with weather forecasts and historical crop patterns.",
    icon: <Cpu className="h-8 w-8 text-accent" />,
  },
  {
    number: "03",
    title: "Get Recommendations",
    description: "Receive a tailored list of crops with high success rates, estimated yield, and market price potential.",
