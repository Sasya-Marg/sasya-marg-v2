...
import { ArrowRight, Sprout, ShieldCheck, CloudSun, CheckCircle2, AlertTriangle, XCircle } from 'lucide-react';

const HeroSection = () => {
  return (
    <section className="relative w-full overflow-hidden bg-background pt-12 pb-20 lg:pt-20 lg:pb-28">
      
      <div className="absolute top-0 right-0 -mr-20 -mt-20 h-[500px] w-[500px] rounded-full bg-primary/10 blur-3xl filter" />
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 h-[400px] w-[400px] rounded-full bg-accent/10 blur-3xl filter" />
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="flex flex-col items-start space-y-6">
            <div className="inline-flex items-center rounded-full border border-primary/20 bg-secondary px-3 py-1 text-xs font-medium text-primary">
              ...
              AI Model 2.0 Live Now
            </div>

            <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl">
              Cultivating the Future with <span className="text-primary">Smart Data.</span>
            </h1>

            <p className="max-w-xl text-base text-muted-foreground sm:text-lg">
              Empower your farm with Sasya-Marg. Get precise crop suggestions based on your soil and water levels to maximize your yield.
            </p>
            ...
            <div className="relative rounded-2xl border border-border bg-card p-6 shadow-xl">
              ...
              <div className="flex items-center justify-between border-b border-border pb-4 mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Crop Suggestions</p>
                    <p className="text-xs text-muted-foreground">Based on your Soil & Water</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between rounded-lg border border-border bg-background p-3 hover:border-primary/50 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-foreground">Potato</p>
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-[10px] text-primary uppercase font-semibold">Recommended</span>
                  </div>
                </div>

                <div className="flex items-center justify-between rounded-lg border border-border bg-background p-3 opacity-90">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-yellow-100 flex items-center justify-center text-xl">🌾</div>
                    <div>
                      <p className="text-sm font-bold text-foreground">Wheat</p>
                      <p className="text-xs text-muted-foreground">Moderate Water Req</p>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <span className="text-[10px] text-yellow-600 uppercase font-semibold">Average</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between rounded-lg border border-border bg-background p-3 opacity-75">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Water Scarcity Risk</p>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <span className="text-[10px] text-destructive uppercase font-semibold">Risky</span>
                  </div>
                </div>
              ...
              <div className="mt-4 pt-3 border-t border-border text-center">
                <p className="text-xs text-muted-foreground">AI analysis complete for UP West Region</p>
              </div>
            </div>
