          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our system automates the complex science of agronomy. You provide the basics, and we handle the weather forecasting and market logic.
              </p>
            </div>
            ...
            <div className="space-y-6 relative">
              ...
              <div className="relative flex items-start gap-4 p-4 rounded-xl hover:bg-secondary/30 transition-colors z-10 bg-background">
                ...
                <div>
                  <h4 className="font-bold text-foreground text-lg">Fill Farm Data</h4>
                  <p className="text-sm text-muted-foreground mt-1">Enter Previous Crop, Soil Type, Water Source, and Budget.</p>
                </div>
              </div>

              <div className="relative flex items-start gap-4 p-4 rounded-xl hover:bg-secondary/30 transition-colors z-10 bg-background">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-accent bg-background text-accent-foreground">
                  <MapPin className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-foreground text-lg">Auto-Location & Weather</h4>
                  <p className="text-sm text-muted-foreground mt-1">We detect your region and fetch real-time rainfall & temp forecasts automatically.</p>
                </div>
              </div>
              ...
              <div className="relative flex items-start gap-4 p-4 rounded-xl hover:bg-secondary/30 transition-colors z-10 bg-background">
                ...
                <div>
                  <h4 className="font-bold text-foreground text-lg">AI Layer Processing</h4>
                  <p className="text-sm text-muted-foreground mt-1">Our Rule-Based AI matches your conditions against 20+ crop models.</p>
                </div>
              </div>

              <div className="relative flex items-start gap-4 p-4 rounded-xl hover:bg-secondary/30 transition-colors z-10 bg-background">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-green-600 bg-background text-green-600">
                  <Sprout className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-foreground text-lg">Recommended Crops</h4>
                  <p className="text-sm text-muted-foreground mt-1">Get a ranked list of top 3 crops suitable for your land.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative mx-auto w-full max-w-95 rounded-[3rem] border-8 border-muted bg-background shadow-2xl overflow-hidden h-175 flex flex-col">
              ...
              <div className="bg-primary px-6 pt-10 pb-6 text-primary-foreground shrink-0">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-[10px] font-medium bg-white/20 px-2 py-1 rounded-full uppercase tracking-wide">Live Demo</span>
                </div>
              ...
              <div className="p-6 grow flex flex-col overflow-hidden relative">
                ...
                {demoStep === 'input' && (
                  <div className="space-y-5 animate-in fade-in zoom-in duration-300">
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Previous Crop</label>
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Soil Type</label>
                      <div className="h-12 w-full rounded-xl bg-secondary/30 border border-border flex items-center px-4 text-sm font-medium text-foreground">
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Water Source</label>
                      <div className="h-12 w-full rounded-xl bg-secondary/30 border border-border flex items-center px-4 text-sm font-medium text-foreground">
                        Tubewell Available
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Budget (Per Acre)</label>
                ...
                {demoStep === 'scanning' && (
                  <div className="grow flex flex-col items-center justify-center text-center space-y-6 animate-in fade-in duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-foreground text-lg">Locating Farm...</h4>
                      <p className="text-xs text-muted-foreground mt-1">Fetching Weather Data for <br/> <span className="text-primary font-semibold">Agra, UP West</span></p>
                    </div>
                    <div className="flex gap-2 text-xs bg-secondary/50 px-4 py-2 rounded-lg">
                       <CloudSun className="h-4 w-4 text-accent" /> 32°C / 80% Humidity
                    </div>
                  </div>
                )}
                ...
                {demoStep === 'ai' && (
                  <div className="grow flex flex-col items-center justify-center text-center space-y-6 animate-in fade-in duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Matching soil & budget against <br/> 20+ crop models...</p>
                    </div>
                  </div>
                )}
                ...
                {demoStep === 'result' && (
                  <div className="space-y-3 animate-in slide-in-from-bottom-10 duration-500 overflow-y-auto pb-4 custom-scrollbar">
                    ...
                    <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Top Recommendations</div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-4 transition-all hover:scale-[1.02] cursor-pointer shadow-sm">
                      <div className="absolute top-0 right-0 bg-green-600 text-white text-[10px] px-2 py-1 rounded-bl-lg font-bold">98% Match</div>
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center text-lg">🌻</div>
                        <div>
                           <h4 className="font-bold text-green-900 dark:text-green-100 text-sm">Sunflower</h4>
                           <p className="text-[10px] text-green-700 dark:text-green-300">High Profit • Low Water</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-800 p-4 transition-all hover:scale-[1.02] cursor-pointer opacity-90">
                      <div className="absolute top-0 right-0 bg-yellow-500 text-white text-[10px] px-2 py-1 rounded-bl-lg font-bold">85% Match</div>
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-yellow-100 dark:bg-yellow-800 flex items-center justify-center text-lg">🌽</div>
                        <div>
                           <h4 className="font-bold text-yellow-900 dark:text-yellow-100 text-sm">Maize (Corn)</h4>
                           <p className="text-[10px] text-yellow-700 dark:text-yellow-300">Moderate Water • Good Yield</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800 p-4 transition-all hover:scale-[1.02] cursor-pointer opacity-75">
                      <div className="absolute top-0 right-0 bg-red-500 text-white text-[10px] px-2 py-1 rounded-bl-lg font-bold">Risky</div>
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-red-100 dark:bg-red-800 flex items-center justify-center text-lg">🌾</div>
                        <div>
                           <h4 className="font-bold text-red-900 dark:text-red-100 text-sm">Paddy (Rice)</h4>
                           <p className="text-[10px] text-red-700 dark:text-red-300">Requires High Water</p>
                        </div>
                      </div>
                    </div>
