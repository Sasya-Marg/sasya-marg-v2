                      ...
                      <div className="pt-2">
                        ...
                        <div className="flex bg-muted rounded-lg p-1.5 gap-1">
                          <button
                            ...
                            className={`flex-1 text-xs font-bold py-2.5 rounded-md transition-all shadow-sm ${listingType === "ready" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-background/50"}`}
                          >
                            Ready Stock
                          </button>
                          <button
                            onClick={() => setListingType("pre-harvest")}
                            className={`flex-1 text-xs font-bold py-2.5 rounded-md transition-all shadow-sm ${listingType === "pre-harvest" ? "bg-accent text-accent-foreground" : "text-muted-foreground hover:bg-background/50"}`}
                          >
                            Pre-Booking
                          </button>
                        </div>
